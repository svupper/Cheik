...
public class Jeu {
	...
	public void deplacerVersAutrePiece(Commande commande) {
		...
		pieceSuivante=getFromMaze(pieceSuivante);//le probleme vient peut etre de la fonction pick( atester) ou bien je ne fais que passer des elements non modifi� dans la liste Maze.
